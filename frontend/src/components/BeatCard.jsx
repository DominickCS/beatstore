export default function BeatCard({ data, currentlyPlaying, setCurrentlyPlaying }) {
  ...
  return (
    <div key={data.id} className={isPlaying ? "py-8 border border-white hover:cursor-pointer rounded shadow-2xl shadow-white/40 transition-all duration-1000" : "hover:cursor-pointer hover:scale-90 duration-500 transition-all"} onClick={() => setCurrentlyPlaying(data)}>
